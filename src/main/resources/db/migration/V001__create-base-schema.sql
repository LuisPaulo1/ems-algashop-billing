...
alter table public.payment_settings
    add constraint fk_payment_settings_credit_card_id foreign key (credit_card_id) references public.credit_card (id);
...
alter table public.invoice
    add constraint fk_invoice_payment_settings_id foreign key (payment_settings_id) references public.payment_settings (id);
...
alter table public.invoice_line_item
    add constraint fk_invoice_line_item_invoice_id foreign key (invoice_id) references public.invoice (id);
